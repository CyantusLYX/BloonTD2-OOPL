...
public:
   ...
   */
  [[nodiscard]]
  Util::PTSDPosition getStartPoint() const {
   ...
   */
  [[nodiscard]]
  Util::PTSDPosition getEndPoint() const {
   ...
   */
  [[nodiscard]]
  Util::PTSDPosition getPositionAtDistance(float distance) const;
   ...
   */
  [[nodiscard]]
  Util::PTSDPosition getPositionAtPercentage(float percentage) const {
   ...
   */
  [[nodiscard]]
  float getDistanceAtPosition(const Util::PTSDPosition &position) const;
   ...
   */
  [[nodiscard]]
  float getPercentageAtPosition(const Util::PTSDPosition &position) const {
   ...
   */
  [[nodiscard]]
  bool isOnPath(const Util::PTSDPosition &position) const;
...
private:
   ...
   */
  [[nodiscard]]
  std::pair<size_t, float> findSegmentAtDistance(float distance) const;
};
