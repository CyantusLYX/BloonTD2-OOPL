...
private:
  ...
  std::shared_ptr<Components::CollisionComponent> m_triggerComponent;  // 觸發範圍
  std::shared_ptr<Components::CollisionComponent> m_explosionComponent; // 爆炸範圍
  float speed = 15.0f;
...
public:
  ...
  std::shared_ptr<Components::CollisionComponent> getExplosionComponent() const {
