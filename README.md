...
2. 關卡
   ...
   * 機制：
        ...
        3. 若 **氣球衝出畫面外**，則依照其本身和可以生成的所有氣球數量 *扣減生命值*
           每氣球扣除一點生命值
        4. **OP模式(DEBUG模式)** 按鈕皆為 $${\color{orange}橘黃色系}$$ ，具有三種功能：
            1. `INFINITY`：按下時在 $${\color{gray}灰色}$$ 及 $${\color{orange}橘黃色}$$ 之間切換按鈕顏色。
               * 當按鈕顏色為 $${\color{orange}橘黃色}$$ ，*免除扣減生命值* 以及 *免費放置所有類型的塔*
               * 當按鈕顏色為 $${\color{gray}灰色}$$ ，*遊戲邏輯正常運作*
